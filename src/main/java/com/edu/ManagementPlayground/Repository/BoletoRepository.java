...
public interface BoletoRepository extends JpaRepository<Boleto, Long> {
    ...
    @Query("SELECT new com.edu.ManagementPlayground.Dto.BoletoResponseDto(bl.typeableLine, bl.dueDate, bl.value, bl.paymentStatus, bl.fileReference) FROM Boleto bl")
